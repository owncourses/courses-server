 ...
 */
final class Version20190309111738 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE npd_module ALTER created SET DEFAULT \'now()\'');
        $this->addSql('ALTER TABLE course ALTER created TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE course ALTER created SET DEFAULT \'now()\'');
        $this->addSql('ALTER TABLE npd_user ALTER created TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE npd_user ALTER created SET DEFAULT \'now()\'');
    }
}
